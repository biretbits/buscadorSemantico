...
"total_de_estudiantes_estadisticas":"select * from cursa_asignatura",
}
...
def buscar(texto):
    ...
    if response:
        ...
        return vect1
textoo = "estadisticas de estudiantes aprobados y reprobados por año o grados, a nivel  general, areas Tecnologia salud social y carreras"
re = buscar(textoo)
