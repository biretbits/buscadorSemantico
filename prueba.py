...
from comprobar import palabras_departamento,palabras_provincia,encontrar_nombre,encontrar_apellido,obtener_area
import nltk
...
textoo = "area de tecnologia y tambien en area salud"
re = buscar(textoo)
