...
["todas total mostrar detalle detalles informacion visualizar estudiante estudiantes carreras carrera area tecnologia salud social unsxx cuantos todos",["estudiante_por_area"]]]
...
def buscar(texto):
    ...
    if response:
        ...
        return vect1
textoo = "cuantos estudiantes aplazados y activos y del departamento de oruro tenemos en el area tecnologia"
re = buscar(textoo)
